...
import 'package:quizu/ui/widgets/snackBar.dart';
...
class ResetNameView extends StatefulWidget {
  ResetNameView({
    Key key,
  }) : super(key: key);

  @override
  State<ResetNameView> createState() => _ResetNameViewState();
}

class _ResetNameViewState extends State<ResetNameView> {
  @override
              ...
              Expanded(
                child: ListView(
                  children: [
                    ...
                    Center(
                      child: Text(
                        'It looks like you have a new name :)',
